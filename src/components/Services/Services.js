...
function Services() {
  ...
  return (
    <>
      <SectionTitle
        title="What I do?"
        desc="As you begin to explore more about me, you might wonder what i do as front end developer."
        headingColor="#eee"
        contentColor="black"
        value={value}
      />
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-4 col-sm-6 des">
                ...
                <p className="mb-4">
                  I can help with the first steps of creating your website with
                  a wireframe or mock-up design. I can make a low-fidelity or
              ...
              <div className="col-md-4 col-sm-6 des">
                ...
                <p className="mb-4">
                  I will bring your website to life with the latest
                  technologies! I can make a simple landing page, static or
                  dynamic site, blog, or e-commerce site. I focus on mobile
                  responsiveness, security, SEO, and accessibility.
                </p>
                <hr className="break" />
              </div>
              <div className="col-md-4 col-sm-6 des">
              ...
              <div className="col-md-4 col-sm-6 des">
                ...
                <p className="mb-4">
                  Clean code is code which is easy to read and understand as
                  well as easy for any developer to maintain and modify. It
                  means that assigned names are meaningful but not too long. No
                  parts of code should be repeated, and almost everything should
                  be consistent
                </p>
                <hr className="break" />
              </div>
              ...
              <div className="col-md-4 col-sm-6 des">
                ...
                <p className="mb-4">
                  ...
                  away. I perform Functional testing to test functionality on
                  your site, Unit testing for small bits of code. I use Programs
                  like Mocha and Jasmine to speed up and simplify your testing
                  process.
                </p>
              </div>
            </div>
